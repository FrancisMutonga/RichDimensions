...
export default function AddProduct() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!product.name || !product.categoryId || !product.price || !product.type) {
  ...
  return (
    <div className="max-w-4xl mx-auto p-8  bg-white/50 shadow-xl rounded-2xl mt-10">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
       ...
       <div className="flex justify-center">
        <button
          type="submit"
          className=" hover:bg-teal-700 hover:text-white  text-teal-700 bg-white py-3 px-6 rounded-full font-semibold  transition"
          disabled={loading}
        >

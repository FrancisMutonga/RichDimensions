  ...
  return (
    <div className="max-w-md mx-auto  p-6  backdrop-blur-sm">
      <div className=" h-32 rounded-xl relative">
        <button
          onClick={() => router.back()}
          className="absolute top-4 left-0 bg-white/50 hover:bg-teal-700 hover:text-white text-teal-700 p-2 rounded-lg backdrop-blur-sm"
        >
          <FaArrowLeft />
        </button>
      </div>
      ...
      <div className="flex flex-col items-center text-center">
        <div className="w-28 h-28 rounded-full border-2 border-teal-700 shadow-md overflow-hidden flex items-center justify-center bg-teal-50">
          {profile.photoURL ? (
            <Image
        ...
        <h2 className="mt-4 text-xl font-bold text-teal-700">

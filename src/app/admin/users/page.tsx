  ...
  return (
    <div className="p-6 mt-10">
      <div className="flex flex-row gap-10 items-center mb-4">
        <h1 className="text-xl sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold text-teal-700">
          Manage Users
        </h1>
        <Link
          href="/admin/users/new"
          className="text-teal-700 bg-white/40 hover:bg-teal-700 hover:text-white px-4 py-2 rounded-xl shadow-md transition font-medium"
        >
          + Add User
        </Link>
      </div>
            ...
            filteredUsers.map((user) => (
              <Link href={`/admin/users/${user.id}`} key={user.id}>
                <div className="cursor-pointer min-w-[160px] flex flex-col items-center bg-white rounded-xl shadow-md p-4 hover:shadow-lg transition">
                  ...
                  <div className="mt-3 text-xl font-semibold text-teal-700 text-center">
                    {user.username}
                  </div>

...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen p-10 ">
      <h1 className="text-3xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-teal-700  mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 shadow-md rounded-xl">
          <h3 className="font-bold text-center text-xl text-teal-700 mb-2">
            Quick Actions
          </h3>
          <div className="flex flex-wrap justify-center gap-3">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              <Link href="/admin/listings/new">
                <button className="bg-teal-700 text-white px-4 py-2 rounded-lg hover:bg-blue-700">
                  + Add User
                </button>
              </Link>

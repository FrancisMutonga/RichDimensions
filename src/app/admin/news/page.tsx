  ...
  return (
    <div className="max-w-7xl mx-auto p-6 mt-16">
      ...
      <div className="flex justify-between items-center mb-10">
        <h2 className="text-2xl sm:text-xl md:text-3xl lg:text-5xl font-bold text-teal-700">
          Manage News
        </h2>
        <Link
          href="/admin/news/new"
          className="flex items-center gap-2 hover:bg-teal-700 bg-white hover:text-white text-teal-700 px-5 py-2 rounded-full shadow-md hover:bg-primary/90 transition"
        >
          <Plus size={18} /> Add 
        </Link>
      </div>
